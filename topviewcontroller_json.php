...
session_start();
   ...
   //planのタイトルとidを取得
    ...
    //以下JSONへの変換を試してみる
    $json = {"filename" => $photoname['filename'], "title" => $photoname['title'], "userphoto" => $userphoto2['profilefile'], "partnerphoto" => $partnerphoto['profilefile'], "plantitle" => $plantitle['title'], "mychat" => $newmychat['chat'], "yourchat" => $newyourchat['chat']}
